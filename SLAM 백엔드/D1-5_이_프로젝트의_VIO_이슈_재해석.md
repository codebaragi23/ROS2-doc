...
| 관련 문서 | 이전: [[D1-4_Loop_Closing과_Place_Recognition|SLAM 백엔드 - D1-4. Loop Closing과 Place Recognition]] / 다음: [[C7_Relocalization_감시_로직_구현|RTAB-Map & Nav2 심화 - C7. Relocalization 감시 로직 구현]] |
...
* 다음 문서([[C7_Relocalization_감시_로직_구현|RTAB-Map & Nav2 심화 - C7]])는 SLAM 백엔드가 RTAB-Map이든 ORB-SLAM3든 공통으로 필요한 감시 로직을 다룬다 — 이 문서의 결론(ORB-SLAM3 VIO 미채택)에 따라, 그 구현은 현재 RTAB-Map 기준으로 유지된다.
