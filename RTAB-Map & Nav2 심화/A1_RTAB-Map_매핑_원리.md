...
- RTAB-Map 공식 사이트: introlab.github.io/rtabmap — appearance-based loop closure, 메모리 관리 개념 설명
...
- rtabmap_ros GitHub 이슈 아카이브 — 실전 파라미터 동작 확인 (`Rtabmap/LoopThr`, `Vis/MinInliers` 등)
