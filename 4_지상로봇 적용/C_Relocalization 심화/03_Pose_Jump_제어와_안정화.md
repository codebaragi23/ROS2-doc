...
|---|---|
| 학습 단계 | Level 3 — 심화 |
| 예상 선행 지식 | [[02_RTAB-Map_핵심_파라미터_대응표\|Relocalization 심화 02]], [[00_RTAB-Map_매핑_원리\|지도제작 00]](그래프 최적화) |
| 학습 목표 | Pose Jump가 왜 구조적으로 불가피한지 설명할 수 있다 / `OptimizeFromGraphEnd` 등 완화 수단의 트레이드오프를 안다 / 점프가 costmap·주행에 미치는 영향을 예측할 수 있다 |
| 기준 환경 | Yahboom ROSMASTER X3, RTAB-Map + Nav2 |
...
- 다음: **[[04_실전_진단_체크리스트|지상로봇 적용 - Relocalization 심화 - 04. 실전 진단 체크리스트]]** — 이 문서와 01, 02에서 다룬 개념들을 실제 현장에서 어떤 순서로 확인할지 체크리스트로 정리한다.
