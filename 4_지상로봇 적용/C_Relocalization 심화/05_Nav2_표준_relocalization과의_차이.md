...
|---|---|
| 학습 단계 | Level 3 — 심화 |
| 예상 선행 지식 | [[04_실전_진단_체크리스트\|Relocalization 심화 04]], [[01_좌표계와_로컬라이제이션_기반\|Nav2 내비게이션 01]] |
| 학습 목표 | AMCL 기반 Nav2 표준 방식과 이 프로젝트 방식의 차이를 설명할 수 있다 / `ReinitializeGlobalLocalization`이 왜 이 프로젝트에 안 맞는지 안다 / 향후 구조 개선 방향을 판단할 수 있다 |
| 기준 환경 | 개념 위주 (Nav2 AMCL vs RTAB-Map) |
