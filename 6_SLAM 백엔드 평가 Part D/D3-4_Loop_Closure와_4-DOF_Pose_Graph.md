...
- C6(Relocalization 심화, Part C)에서 다룬 "relocalization을 누가 담당하는가"라는 질문이, VINS-Fusion을 쓸 경우 RTAB-Map과 VINS-Fusion(`loop_fusion_node`) 중 **어느 쪽의 loop closure를 최종 신뢰할지**라는 새로운 형태의 질문으로 바뀐다.
