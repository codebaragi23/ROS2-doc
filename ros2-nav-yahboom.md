...
| 인용 내용 | 인용하는 문서 |
|---|---|
| "active-map IMU reset" 반복 관찰 원본 로그 | [[D1-1_ORB-SLAM3_시스템_개요\|D1-1]], [[D1-3_Multi-Map_System_Atlas와_재추적_병합\|D1-3]] |
| `IMU.fastInit` 진단, 게이팅 격리 테스트, stereo-inertial 대비 실측 | [[D1-2_Visual-Inertial_초기화_알고리즘\|D1-2]], [[D1-5_이_프로젝트의_VIO_이슈_재해석\|D1-5]] |
| `FAST/MinThreshold` 등 튜닝 이력(85회 → 0회) | [[D2-7_이_프로젝트에서의_실측_비교와_튜닝_계획\|D2-7]] |
| 재방문 시 병합 재현 여부 실험 | [[D1-4_Loop_Closing과_Place_Recognition\|D1-4]] |

### OpenVINS / VINS-Fusion (D2·D3 시리즈)

| 인용 내용 | 인용하는 문서 |
|---|---|
| OpenVINS 통합 및 파라미터 사용 이력 | [[D2-2_OpenVINS의_핵심_설계\|D2-2]] |
| 2026-08-21 OpenVINS 코드 분석 + 3개 bag 실측(`fridge_proximity_*`) | [[D2-7_이_프로젝트에서의_실측_비교와_튜닝_계획\|D2-7]], [[D4_ORB-SLAM3_vs_OpenVINS_vs_VINS-Fusion_종합_비교\|D4]] |
| ZUPT 오발동 — 최우선 검증 대기 항목으로 기록됨 | [[D2-8_이_프로젝트의_ZUPT_오발동_가설과_검증_계획\|D2-8]] |
| "IR 스테레오+IMU 백엔드 검토"가 다음 단계 후보로 언급됨 | [[D3-1_VINS-Fusion_개요와_최적화_기반_알고리즘_원리\|D3-1]], [[D3-5_이_프로젝트에_적용한다면\|D3-5]] |
...
|---|---|---|
| `docs/guides/rtabmap_nav_params_tuning_guide.md` | B1, B3, B4, B5, B7, C5 | Nav2/RTAB-Map 실제 설정값과 튜닝 관점 |
| `docs/guides/relocalization_strategy_guide.md` | C1~C6, C2-1 | relocalization 트리거 5분류의 원본 |
