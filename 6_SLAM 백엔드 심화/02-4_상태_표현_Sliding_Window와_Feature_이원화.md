...
|---|---|
| 학습 단계 | Level 4 — 심화 |
| 예상 선행 지식 | [[02-3_초기화_Static_vs_Dynamic\|심화 02-3]] |
| 학습 목표 | 슬라이딩 윈도우 크기가 정확도·연산량에 미치는 영향을 안다 / 두 종류 feature를 왜 나눠 관리하는지 설명할 수 있다 |
...
- 다음: **[[02-5_ZUPT_메커니즘과_자세_안정화|SLAM 백엔드 심화 - 02-5. ZUPT 메커니즘과 자세 안정화]]** — ZUPT의 일반 원리를 다룬다. 이 프로젝트에서 가장 우선순위 높은 미해결 가설은 이어지는 **02-8**에서 다룬다.
