...
| 항목 | 내용 |
|---|---|
| 학습 단계 | Level 4 — 심화 (일반 이론) |
| 예상 선행 지식 | [[02-4_상태_표현_Sliding_Window와_Feature_이원화\|심화 02-4]] |
| 학습 목표 | ZUPT가 무엇을 이용해 드리프트를 잡는지 설명할 수 있다 / 정지 판정의 기준을 안다 / 오발동 시 어떤 증상이 나타날지 예측할 수 있다 |
| 기준 환경 | 개념 위주 (관성항법 일반 원리) |
